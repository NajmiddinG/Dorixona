...
# Form implementation generated from reading ui file 'Mahsulot_olish.ui'
#
...
"border-radius:20px;")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Mahsulot olish"))
        self.label.setText(_translate("Form", "Mahsulot olish"))
        self.lineEdit.setPlaceholderText(_translate("Form", " Qidiruv..."))
        self.pushButton_2.setText(_translate("Form", "Yangi qo\'shish"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Xodim"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("Form", "Firma"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("Form", "Summa"))
        ...
        item.setText(_translate("Form", "Olingan dorilar"))
import resource_rc

...
# Form implementation generated from reading ui file 'Sotuv.ui'
#
...
"border-radius:20px;")
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Sotuv"))
        self.label.setText(_translate("Form", "Sotuv"))
        self.lineEdit_2.setPlaceholderText(_translate("Form", "Qidiring..."))
        self.pushButton.setText(_translate("Form", "Qo\'shish"))
        self.pushButton_21.setText(_translate("Form", "Sotish"))
        ...
        item.setText(_translate("Form", "Soni"))
import resource_rc
